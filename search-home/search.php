  ...
  if (isset($_REQUEST['search'])) {
    ...
    if (empty($search)) {
        ...
        // Phan dung vong lap while show du lieu
            ...
            $sql=$conn->query ("SELECT * FROM nguoi_dung where dia_chi like  '%$search%' ");
                ...
                <nav class="category">
                    ...
                    <!-- <ul class="category-list"> 
                        ...
                        <li class="category-item ">
                            <a href="./list_user.php" class="category-item__link">Tất Cả Giới Tính</a>
                        </li>
                        <?php 
                        ...
                        ?>
                        <li class="category-item ">
                            <a href="./list_user.php?idcategory=<?=$row['id_nd']?>" class="category-item__link"><?= $row['gioitinh']?></a>
                        </li>
                        <?php }} ?>
                    ...
                    <ul class="category-list"> 
                        ...
                        <li class="category-item ">
                            <a href="./list_user.php" class="category-item__link">Sắp xếp theo giới tính</a>
                        </li>
                       
                        <li class="category-item ">
                            <a href="./list_user_nam.php" class="category-item__link">Nam</a>
                            <a href="./list_user_nu.php" class="category-item__link">Nữ</a>
                        </li>
                    ...
                    <!-- <ul class="category-list"> 
                        ...
                        <li class="category-item ">
                            <a href="./index.php" class="category-item__link">Tất Cả Loại Tiện Nghi</a>
                        </li>
                       
                        <li class="category-item ">
                            <a href="./index.php?idcategory=<?=$row['id_danhmuc']?>" class="category-item__link"><?= $row['ten_danhmuc']?></a>
                        </li>
                        ...
                        ?>
                            <div class="grid__column-2-4 ">  
                                    ...
                                    <!-- <div class="home-pruduct-item__img" style="background-image: url(https://cdn1.viettelstore.vn/images/Product/ProductImage/medium/1675652850.jpeg);"></div> -->
                                         <img src="../img/avata/<?= $row['hinhanh'] ?>" class="w-100" alt="<?= $row['ten_xe']?>"/>
                                    ...
                                    <h6 class="home-pruduct-name" style="font-size: 18px;    height: 21px;"> Ngân sách tối đa <?= $row['ngansach'] ?> </h6>
            ...
            <div class="container_home_list">
                <div class="list_modal">
                    <div class="list_left">
                      ...
                      <img src="../img/p250020801.png" class="w-100 h-100" style="" alt="<?= $row['ten_xe']?>"/>
                    ...
                    <div class="list_right">
                        <div class="primary_info">
                            <div class="list_user">
                                <div class="name">
                                    <span class="fw-bold">Ngân</span>
                                </div>
                                <div class="user_info">
                                    <span>23 tuổi. Nữ</span>
                                </div>
                                <div class="user_info">
                                    <span>Ngân sách tối đa: 1tr8 / tháng</span>
                                </div>
                            </div>
                        </div>
                    
                        <div class="messa_info">
                            <span style="font-size: 14px;letter-spacing: .01em;text-align: left;line-height: 1.45em; vertical-align: inherit;" >Studio rộng 30m2 T2 sẽ có mặt trong thời gian tôi vắng mặt trong thời gian mười ngày từ 28/7 đến 8/6/24. Căn hộ được trang bị đầy đủ nội thất và rất yên tĩnh. Nó nằm ở quận 13 của Paris, trong một khu vực rất đẹp, Butte aux Cailles rất gần giao thông, ba tuyến xe buýt metro, v.v. và các cửa hàng. Nó được trang bị đầy đủ nội thất (bàn ghế giường) và được trang bị (bếp điện, tủ lạnh, máy giặt, tủ lạnh) có lối vào phòng chính, phòng tắm, bồn cầu, bếp riêng và ban công có lối ra vào và nhìn ra vườn. Lý tưởng cho một hoặc hai người. GIÁ là 40 euro mỗi ngày Nếu quan tâm, bạn có thể liên hệ với tôi</span>
                        </div>
                        ...
                        <div class="listing_footer_buttons">
                            <div class="listing_footer_buttons_container" style="float: left;">
                                <button class="mes">
                                 ...
                                 <font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Gửi tin nhắn</font></font>
                                </button>
