...
if(isset($_GET['idcategory'])){
    ...
    $result = $conn->query("SELECT * FROM nguoi_dung where gioitinh = 'Nam' ");
} 
...
<body>
    <header>
        ...
        <div class="search-menu">
                ...
                <div class="search-tool" style="    margin-left: 570px !important;">
                    ...
                    <?php 
                            if ($result->num_rows > 0) {
                                while($row = $result-> fetch_assoc()) {
                                    if(isset($row['ghichu']) && $row['ghichu'] !== ''){
                                        if(isset($row['trang_thai']) && $row['trang_thai'] == 0){
                        ...
                        ?>
                            <div class="grid__column-2-4 ">  
                                    ...
                                    <h6 class="home-pruduct-name" style="font-size: 18px; height: 20px;"> Ngân sách tối đa  </h6>
                                    <h6 class="home-pruduct-name" style="font-size: 18px;">  <?= number_format($row['ngansach']) ?> VNĐ</h6>
