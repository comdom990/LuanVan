        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Thống kê chở ở</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-6">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <h2>Thống Kê Số Lượng chở ở theo địa chỉ</h2>
                        ...
                        <!-- <div class="col-lg-6">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <span id="text-date-nd"></span>
                                    <div id="morris-area-chart-nd" style="height: 250px;"></div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var char = new Morris.Bar({
            ...
            labels: ['Số lượng chỗ ở'], // Nhãn cho trục y
