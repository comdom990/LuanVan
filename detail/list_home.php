    ...
    <div class="home_lis text-center" id="home_lis" >
        ...
        <?php 
              if(isset($_GET['id'])) {
                ...
                $idProduct = $_GET['id'];
                $conn = connectDB();
                $result = $conn -> query("SELECT  p.so_luong_nguoi,nd.hinhanh,ha.anh,nd.ngaysinh,p.id_pt,p.dien_tich_phong,p.gia_dien,p.gia_nuoc,tn.ten_tiennghi,qd.ten_quydinh,nd.hoten,co.dia_chi,bd.mo_ta,bdp.gia,nd.id_nd,nd.gioitinh,l.ten_loai,co.dien_tich,bd.ngay_dang,bd.ngay_thue_trong,tnc.ten_tnc
             ...
             ON qd.id_pt = p.id_pt and tnc.id_cho = co.id_cho and co.id_bd = bd.id_bd and co.id_nd = nd.id_nd and nd.id_nd = bd.id_nd and bdp.id_bd = bd.id_bd and p.id_pt = ha.id_pt and p.id_cho = co.id_cho WHERE p.id_pt = ".$idProduct." and ha.anh_dai_dien = 1 ");
              ...
              if ($result->num_rows > 0) {
                    while($row = $result-> fetch_assoc()) {
                        $current_price = $row['gia'];
                        $current_area = $row['dien_tich_phong'];
                    ...
                    <div class="list_left">
                        <div class="list_navi">
                            <ul style="  padding: 0; margin: 0; list-style-type: none;">
                                ...
                                <li class="list_nav">
                                    ...
                                    <a href="list_home_lq.php?price='.$row['gia'] .'&area='.$row['dien_tich_phong'] .'"  style=" color: #fff; text-decoration: none;">BÀI ĐĂNG LIÊN QUAN </a>
                      ...
                      ';?>
                           <div class="img_main">
                            ...
                            <div class="img_list">
                              <?php  if ($result_anh -> num_rows > 0) {
                                while($row2 = $result_anh -> fetch_assoc()){?>  
                                <img class="border img-fluid" src="../img/<?php echo $row2['anh']; ?>" onclick=""> 
                                 <?php }}?>
